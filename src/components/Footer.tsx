      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-400">
              103 Medicentre provides quality primary healthcare services to the
              Durban community. Dr Nirjhar Dev Bhatta and team are committed to
              delivering compassionate, professional medical care for you and your
              family.
            </p>
        ...
        <div className="mt-12 border-t border-slate-800 pt-8">
          <p className="text-center text-sm text-slate-400">
            &copy; {currentYear} Dr N D Bhatta 103 Medicentre. All rights
            reserved. | Professional General Practitioner Services in Durban
          </p>
        </div>
      </div>
    </footer>
